...
## Apothecary Hero Concept

Files:

- `apothecary_hero_concept.png`: transparent reviewed concept image.
- `../sprites/source/apothecary_hero_concept_chroma.png`: generated chroma-key source.
...
```text
Adult female ship apothecary hero for a dark sci-fi survival shooter.
Attractive action heroine with pronounced feminine silhouette and large bust in a fitted practical sealed apothecary/field-medic combat suit.
No nudity, no explicit pose.
